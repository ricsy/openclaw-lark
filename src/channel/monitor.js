...
import { handleMessageEvent, handleReactionEvent, handleBotMembershipEvent, handleCardActionEvent, handleRecallEvent, } from './event-handlers';
...
async function monitorSingleAccount(params) {
    ...
    await lark.startWS({
        handlers: {
            ...
            'im.message.recall_v1': (data) => handleRecallEvent(ctx, data),
